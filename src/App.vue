    ...
    <div class="flex flex-col w-full items-center">
      <div class="w-full max-w-lg p-4 space-y-6">
        ...
        <div class="flex justify-center items-center gap-8">
          <VSpinner
            class="border-2 border-green-400 border-r-transparent border-t-transparent"
          />

          <VSpinner
            class="wi-fastest w-10 h-10 border-4 border-blue-500 border-r-transparent border-l-transparent"
          />
